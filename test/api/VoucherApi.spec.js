...
describe('VoucherApi', function() {
  describe('createVoucher', function() {
    it('should call createVoucher successfully', async function() {
      try {
        let result = await instance.createVoucherWithHttpInfo({});
  ...
  describe('getVoucher', function() {
    it('should call getVoucher successfully', async function() {
      try {
        let result = await instance.getVoucherWithHttpInfo({});
        expect(result.response.statusCode).to.be.greaterThan(199);
        expect(result.response.statusCode).to.be.lessThan(300);
      } catch (error) {
        expect(error.status).to.be.greaterThan(399);
  ...
  describe('getVouchers', function() {
    it('should call getVouchers successfully', async function() {
      try {
        let result = await instance.getVouchersWithHttpInfo({});
        expect(result.response.statusCode).to.be.greaterThan(199);
        expect(result.response.statusCode).to.be.lessThan(300);
      } catch (error) {
        expect(error.status).to.be.greaterThan(399);
  ...
  describe('sendElectronicVoucher', function() {
    it('should call sendElectronicVoucher successfully', async function() {
      try {
        let result = await instance.sendElectronicVoucherWithHttpInfo({});
        expect(result.response.statusCode).to.be.greaterThan(199);
        expect(result.response.statusCode).to.be.lessThan(300);
      } catch (error) {
        expect(error.status).to.be.greaterThan(399);
  ...
  describe('sendVoucherByEmail', function() {
    it('should call sendVoucherByEmail successfully', async function() {
      try {
        let result = await instance.sendVoucherByEmailWithHttpInfo({});
        expect(result.response.statusCode).to.be.greaterThan(199);
        expect(result.response.statusCode).to.be.lessThan(300);
      } catch (error) {
        expect(error.status).to.be.greaterThan(399);
