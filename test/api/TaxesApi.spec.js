 ...
 */
 ...
 (function (root, factory) {
  ...
  before(async function () {
    ...
    instance = new SiigoApi.TaxesApi();
  });
  ...
  describe("getTaxes", function () {
    it("should call getTaxes successfully", async function () {
      ...
      expect(result.response.body[0].name).to.be('IVA 19%');
      expect(result.response.body[0].type).to.be('0');
      expect(result.response.body[0].percentage).to.be(19);
