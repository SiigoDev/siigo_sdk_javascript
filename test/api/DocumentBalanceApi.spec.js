...
(function(root, factory) {
  ...
  describe('DocumentBalanceApi', function() {
    describe('getDocumentBalances', function() {
      it('should call getDocumentBalances successfully', function(done) {
        //uncomment below and update the code to test getDocumentBalances
        //instance.getDocumentBalances(function(error) {
