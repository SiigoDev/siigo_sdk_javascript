...
beforeEach(function() {
  instance = new SiigoApi.UpdateCustomerCommand();
});

describe('UpdateCustomerCommand', function() {
  it('should create an instance of UpdateCustomerCommand', function() {
    // uncomment below and update the code to test UpdateCustomerCommand
    //var instance = new SiigoApi.UpdateCustomerCommand();
    //expect(instance).to.be.a(SiigoApi.UpdateCustomerCommand);
  });
