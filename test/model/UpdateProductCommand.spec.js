...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiigoApi.UpdateProductCommand();
  });
  ...
  describe('UpdateProductCommand', function() {
    it('should create an instance of UpdateProductCommand', function() {
      // uncomment below and update the code to test UpdateProductCommand
      //var instance = new SiigoApi.UpdateProductCommand();
      //expect(instance).to.be.a(SiigoApi.UpdateProductCommand);
    });
