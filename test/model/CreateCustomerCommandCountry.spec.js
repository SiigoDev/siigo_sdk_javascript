...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiigoApi.CreateCustomerCommandCountry();
  });
  ...
  describe('CreateCustomerCommandCountry', function() {
    it('should create an instance of CreateCustomerCommandCountry', function() {
      // uncomment below and update the code to test CreateCustomerCommandCountry
      //var instance = new SiigoApi.CreateCustomerCommandCountry();
      //expect(instance).to.be.a(SiigoApi.CreateCustomerCommandCountry);
    });
