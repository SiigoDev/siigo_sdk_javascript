...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiigoApi.CreateProductCommand();
  });
  ...
  describe('CreateProductCommand', function() {
    it('should create an instance of CreateProductCommand', function() {
      // uncomment below and update the code to test CreateProductCommand
      //var instance = new SiigoApi.CreateProductCommand();
      //expect(instance).to.be.a(SiigoApi.CreateProductCommand);
    });
