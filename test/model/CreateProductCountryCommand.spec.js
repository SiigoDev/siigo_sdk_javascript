...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SiigoApi.CreateProductCountryCommand();
  });
  ...
  describe('CreateProductCountryCommand', function() {
    it('should create an instance of CreateProductCountryCommand', function() {
      // uncomment below and update the code to test CreateProductCountryCommand
      //var instance = new SiigoApi.CreateProductCountryCommand();
      //expect(instance).to.be.a(SiigoApi.CreateProductCountryCommand);
    });
