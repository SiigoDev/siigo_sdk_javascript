 ...
 */
/**
 * The CreateProductCountryCommand model module.
 * @module model/CreateProductCountryCommand
 * @version v1
 */
var CreateProductCountryCommand = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateProductCountryCommand</code>.
   * @alias module:model/CreateProductCountryCommand
   */
  function CreateProductCountryCommand() {
    (0, _classCallCheck2["default"])(this, CreateProductCountryCommand);
    CreateProductCountryCommand.initialize(this);
  }
  /**
   ...
   */
  (0, _createClass2["default"])(CreateProductCountryCommand, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>CreateProductCountryCommand</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateProductCountryCommand} obj Optional instance to populate.
     * @return {module:model/CreateProductCountryCommand} The populated <code>CreateProductCountryCommand</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CreateProductCountryCommand();
  ...
  return CreateProductCountryCommand;
}();
/**
 ...
 */
CreateProductCountryCommand.prototype['product_id'] = undefined;
 ...
 * @member {String} code
 */
CreateProductCountryCommand.prototype['code'] = undefined;

/**
 * Represents the name of product or service.
 * @member {String} name
 */
CreateProductCountryCommand.prototype['name'] = undefined;

/**
 * Represents the id of inventory classification.
 * @member {Number} account_group
 */
CreateProductCountryCommand.prototype['account_group'] = undefined;
 ...
 * @member {String} type
 */
CreateProductCountryCommand.prototype['type'] = undefined;
 ...
 */
CreateProductCountryCommand.prototype['prices'] = undefined;

/**
 * Represents the id of an unit of measurement, by default this field will be 94.
 * @member {String} unit
 */
CreateProductCountryCommand.prototype['unit'] = undefined;

/**
 * Represents Unit of measure for invoice printing.
 * @member {String} unit_label
 */
CreateProductCountryCommand.prototype['unit_label'] = undefined;

/**
 * Represents the Reference or factory code of the product or service.
 * @member {String} reference
 */
CreateProductCountryCommand.prototype['reference'] = undefined;

/**
 * Represents product description.
 * @member {String} description
 */
CreateProductCountryCommand.prototype['description'] = undefined;

/**
 * @member {module:model/AdditionalFieldsProducts} additional_fields
 */
CreateProductCountryCommand.prototype['additional_fields'] = undefined;

/**
 * @member {String} key
 */
CreateProductCountryCommand.prototype['key'] = undefined;
var _default = exports["default"] = CreateProductCountryCommand;
