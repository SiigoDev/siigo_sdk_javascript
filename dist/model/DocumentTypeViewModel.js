...
var _DocumentTypeTaxModel = _interopRequireDefault(require("./DocumentTypeTaxModel.js"));
/**
 * Siigo API
 * Siigo Api v1
 *
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cargo_transportation')) {
          obj['cargo_transportation'] = _ApiClient["default"].convertToType(data['cargo_transportation'], 'Boolean');
        }
...
var _default = exports["default"] = DocumentTypeViewModel;
