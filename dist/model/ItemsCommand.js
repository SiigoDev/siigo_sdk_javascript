...
var _ItemTransportData = _interopRequireDefault(require("./ItemTransportData.js"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('total_price')) {
          obj['total_price'] = _ApiClient["default"].convertToType(data['total_price'], 'Number');
        }
...
var _default = exports["default"] = ItemsCommand;