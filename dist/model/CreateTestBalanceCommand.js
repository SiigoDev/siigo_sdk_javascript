    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('account_start')) {
          obj['account_start'] = _ApiClient["default"].convertToType(data['account_start'], 'Number');
        }

        if (data.hasOwnProperty('account_end')) {
          obj['account_end'] = _ApiClient["default"].convertToType(data['account_end'], 'Number');
        }
...
var _default = CreateTestBalanceCommand;
